...
exports.cesarEncrypt = (letter, step) => text('').map(letter => getEncryptLetter(letter, step)).join('');

exports.cesarDecrypt = (letter, step) => text('').map(letter => getDecryptLetter(letter, step)).join('');
